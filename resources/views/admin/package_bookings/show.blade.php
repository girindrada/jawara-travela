            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
                ...
                <div class="item-card flex flex-row justify-between items-center">
                    <div class="flex flex-row items-center gap-x-3">
                        <img src="{{ Storage::url($packageBooking->tour->thumbnail) }}" alt="thumbnail" class="rounded-2xl object-cover w-[120px] h-[90px]">
                ...
                <div class="grid grid-cols-2 gap-5">
                    ...
                    <div class="flex flex-col gap-y-4">
                        ...
                        <img src="{{ Storage::url($packageBooking->proof) }}" alt="bukti pembayaran" class="rounded-2xl object-cover w-[300px] h-[200px]">
                    </div>
                </div>
