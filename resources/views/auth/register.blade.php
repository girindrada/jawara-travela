    ...
    <section id="content" class="max-w-[640px] w-full mx-auto bg-[#F9F2EF] min-h-screen">
        <div class="w-full min-h-screen flex flex-col items-center justify-center py-[46px] px-4 gap-8">
            <div class="w-[calc(100%-26px)] rounded-[20px] overflow-hidden relative">
                <img src="{{ asset('assets/backgrounds/Asset-signup.png') }}" class="w-full h-full object-contain"
                    alt="background">
            </div>
                    ...
                    <div class="flex flex-col gap-1 w-full">
                        ...
                        <div
                            ...
                            <button type="button" class="reveal-password w-4 h-4 flex shrink-0"
                                ...
                                <img src="{{ asset('assets/icons/password-eye.svg') }}" class="see-password"
                                    alt="icon">
                                <img src="{{ asset('assets/icons/password-eye-slash.svg') }}" class="hide-password hidden"
                                    alt="icon">
                            </button>
                        </div>
                    ...
                    <div class="flex flex-col gap-1 w-full">
                        ...
                        <div
                            ...
                            <button type="button" class="reveal-password w-4 h-4 flex shrink-0"
                                ...
                                <img src="{{ asset('assets/icons/password-eye.svg') }}" class="see-password"
                                    alt="icon">
                                <img src="{{ asset('assets/icons/password-eye-slash.svg') }}"
                                    class="hide-password hidden" alt="icon">
                            </button>
                        </div>
