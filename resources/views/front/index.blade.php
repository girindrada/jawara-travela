        ...
        <nav class="mt-8 px-4 w-full flex items-center justify-between">
            ...
            @guest
                <div class="flex items-center gap-3">
                    <div
                        class="w-12 h-12 border-4 border-white rounded-full overflow-hidden flex shrink-0 shadow-[6px_8px_20px_0_#00000008]">
                        <img src="{{ asset('assets/photos/pfp.png') }}" class="w-full h-full object-cover object-center"
                            alt="photo">
                    </div>
                    <div class="flex flex-col gap-1">
                ...
                @empty
                    <a href="{{ route('front.index') }}" class="group px-2 first-of-type:pl-4 last-of-type:pr-4">
                        <div
                            ...
                            <span
                                class="text-sm tracking-[0.35px] text-[#4D73FF] group-hover:text-white transition-all duration-300">Oops..</span>
                        </div>
                    </a>
                @endforelse
                    ...
                    <a href="{{ route('front.details', $packageTour->slug) }}"
                        ...
                        <div
                            ...
                            <div class="w-full h-[330px] rounded-xl flex shrink-0 overflow-hidden">
                                <img src="{{ Storage::url($packageTour->thumbnail) }}" class="w-full h-full object-cover"
                                    alt="thumbnails">
                            </div>
                                ...
                                <div class="flex flex-col gap-1">
                                    ...
                                    <div class="flex items-center gap-1">
                                        ...
                                        <span class="text-sm text-darkGrey tracking-035">
                                            {{ substr($packageTour->location, 0, 15) }} ...
                                        </span>
                                    </div>
                                </div>
