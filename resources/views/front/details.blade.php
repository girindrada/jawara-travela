...
@section('content')
    <section id="content" class="max-w-[640px] w-full mx-auto bg-[#F9F2EF] min-h-screen flex flex-col gap-8 pb-[120px]">
        ...
        <div id="image-details" class="px-4 flex flex-col gap-3">
            ...
            <div class="grid grid-cols-4 gap-4 w-fit mx-auto">
                ...
                @foreach ($latestPhotos as $latestPhoto)
                    <a href="{{ Storage::url($latestPhoto->photo) }}"
                        class="thumbnail-option w-[74px] h-[74px] flex shrink-0 rounded-xl border-2 overflow-hidden mx-auto opacity-50">
                        <img src="{{ Storage::url($latestPhoto->photo) }}" class="w-full h-full object-cover object-center"
                            alt="thumbnail">
                    </a>
                @endforeach
        ...
        <div class="mx-4 flex flex-col gap-3 bg-white p-[16px_24px] rounded-[22px]">
            ...
            <a href="{{ route('front.index') }}" class="flex items-center justify-between py-2 text-blue">
        ...
        <div
            ...
            <div class="flex flex-col justify-center gap-1">
                ...
                <p class="text-blue font-semibold text-lg leading-[26px] tracking-[0.6px]">
                    Rp {{ number_format($packageTour->price, 0, ',', '.') }}<span
